...
df_cnbc = pd.read_csv('Output_Data/UBS/UBS_CNBC_prepped_20240526_224404_discrete.csv')
df_ft = pd.read_csv('Output_Data/UBS/UBS_FT_prepped_20240526_224634_discrete.csv')
df_nzz = pd.read_csv('Output_Data/UBS/UBS_NZZ_prepped_20240526_231232_discrete.csv')
df_srf = pd.read_csv('Output_Data/UBS/UBS_SRF_prepped_20240526_234137_discrete.csv')
df_nzz_2 = pd.read_csv('Output_Data/UBS/UBS_NZZ_prepped_correction_20240526_234112_discrete.csv')
...
def plot_weekly_average_article_count(df, title):
    ...
    plt.axhline(y=weekly_average, color='red', linestyle='--', label=f'Weekly Average: {weekly_average:.2f}',
                linewidth=2)
    plt.title(f'Weekly Article Count and Average for UBS ({title})', fontsize=20, pad=20)
