...
def process_dataframe(df, bank_name, input_filepath):
    ...
    output_directory = f'Output_Testdata/{bank_folder_map[bank_name]}'
    ...
    log_file = generate_filename(bank_folder_map[bank_name], 'txt', 'Output_Testdata/Logfiles', timestamp)
...
def main():
    ...
    if choice == '1':
        process_directory('Test_Data/CS', 'Credit Suisse')
    elif choice == '2':
        process_directory('Test_Data/UBS', 'UBS')
    else:
